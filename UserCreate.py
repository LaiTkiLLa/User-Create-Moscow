...
def new_user():
    ...
    def create_user():
        ...
        ##########Создание пользователя в AD
        new_user = pyad.aduser.ADUser.create(Account_name, ou, password=user_data['password'], optional_attributes={'sn':sn,
                                                                                                            'givenName':givenName,
...
Office_chosen["values"] = ('Москва', 'Краснодар', 'Казань', 'Новосибирск', 'Омск', 'Ростов-на-Дону', 'Санкт-Петербург', 'Воронеж')
